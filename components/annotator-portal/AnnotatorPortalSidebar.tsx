...
const NAV: { label: string; href: string; exact?: boolean; icon: keyof typeof ICONS }[] = [
  { label: "Dashboard", href: "/annotator-portal", exact: true, icon: "grid" },
  { label: "Matches", href: "/annotator-portal/matches", icon: "folder" },
  { label: "Tasks", href: "/annotator-portal/tasks", icon: "tasks" },
  { label: "Account Settings", href: "/annotator-portal/settings", icon: "gear" },
];
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-20 items-center border-b border-border px-6">
        <Link
          href="/annotator-portal"
          onClick={onNavigate}
          className="flex items-center"
          aria-label="Hornstag annotator portal home"
        >
          <Image
      ...
      <nav className="flex-1 overflow-y-auto px-4 py-6" aria-label="Annotator portal">
...
export default function AnnotatorPortalSidebar({
  user,
  mobileOpen,
  onClose,
  collapsed,
