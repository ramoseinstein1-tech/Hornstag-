...
const ICONS = {
  ...
  users: (
    <>
      ...
      <path d="M3 19c0-3.2 2.5-5.5 5.5-5.5S14 15.8 14 19" />
      <circle cx="16.5" cy="9" r="2.4" />
      <path d="M15 13.6c2.7.2 4.5 2.2 4.5 5.4" />
    </>
  ),
    ...
    <div className="flex h-full flex-col">
      <div className="flex h-20 items-center border-b border-border px-6">
        <Link
          ...
          aria-label="Hornstag admin console home"
        >
          <Image
      ...
      <nav className="flex-1 overflow-y-auto px-4 py-6" aria-label="Admin console">
...
export default function AdminPortalSidebar({
  user,
  mobileOpen,
  onClose,
  collapsed,
